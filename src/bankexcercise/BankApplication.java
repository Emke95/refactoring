...
public class BankApplication extends JFrame {
	...
	Map<String, JMenuItem>  navigationItems = new HashMap<String, JMenuItem>();
	...
	public void initComponents() {
		...
		navigationItems.get("Next Item").addActionListener(next1);

		prevItemButton.addActionListener(prev);
		navigationItems.get("Previous Item").addActionListener(prev);

		firstItemButton.addActionListener(first);
		navigationItems.get("First Item").addActionListener(first);

		lastItemButton.addActionListener(last);
		navigationItems.get("Last Item").addActionListener(last);
		...
		navigationItems.get("List All Records").addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e){
		...
		navigationItems.get("Find By Surname").addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent e){
		...
		navigationItems.get("Find By Account Number").addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e){
	...
	private void setNavMenuItems(Map<String, JMenuItem> navList, JMenu navMenu, ArrayList<String> navMenuItems) {
		navMenuItems.forEach(item -> {
			navList.put(item, new JMenuItem(item));
			navMenu.add(navigationItems.get(item));
		});
	}
